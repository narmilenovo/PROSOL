...
public class PurchasingValueKeyController {
	...
	public ResponseEntity<Object> getPvkById(@PathVariable @NonNull Long id) throws ResourceNotFoundException {
	...
	public ResponseEntity<Object> updatePvk(@PathVariable @NonNull Long id,
	...
	public ResponseEntity<Object> updatePvkStatus(@PathVariable @NonNull Long id) throws ResourceNotFoundException {
	...
	public ResponseEntity<Object> updateBatchPvkStatus(@RequestBody @NonNull List<Long> ids) throws ResourceNotFoundException {
	...
	public ResponseEntity<Object> deletePvk(@PathVariable @NonNull Long id) throws ResourceNotFoundException {
		purchasingValueKeyService.deletePvkById(id);
		return ResponseEntity.noContent().build();
	}

	@DeleteMapping("/deleteBatchPvk")
	public ResponseEntity<Object> deleteBatchPvk(@RequestBody @NonNull List<Long> ids) throws ResourceNotFoundException {
