...
public class DistributionChannelController {
	...
	public ResponseEntity<Object> getDcById(@PathVariable @NonNull Long id) throws ResourceNotFoundException {
	...
	public ResponseEntity<Object> updateDc(@PathVariable @NonNull Long id,
	...
	public ResponseEntity<Object> updateDcStatus(@PathVariable @NonNull Long id) throws ResourceNotFoundException {
	...
	public ResponseEntity<Object> updateBatchDcStatus(@RequestBody @NonNull List<Long> ids) throws ResourceNotFoundException {
	...
	public ResponseEntity<Object> deleteDc(@PathVariable @NonNull Long id) throws ResourceNotFoundException {
		distributionChannelService.deleteDcId(id);
		return ResponseEntity.noContent().build();
	}

	@DeleteMapping("/deleteBatchDc")
	public ResponseEntity<Object> deleteBatchDc(@RequestBody @NonNull List<Long> ids) throws ResourceNotFoundException {
