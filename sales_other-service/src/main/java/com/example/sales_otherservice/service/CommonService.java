...
public class CommonService {
	...
	public List<FormFieldResponse> getSalesExistingFields(String formName) throws ClassNotFoundException {
...
//		return formFields;
	...
	public List<Field> getReflectionFields(String className) throws ClassNotFoundException {
		Class<?> clazz = Class.forName("com.example.sales_otherservice.entity." + className);
	...
	public List<Object> getSalesListOfFieldNameValues(String fieldName, String formName) {
