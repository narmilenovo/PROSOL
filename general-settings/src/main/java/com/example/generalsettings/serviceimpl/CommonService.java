...
public class CommonService {
	...
	public List<FormFieldResponse> getGeneralSettingsExistingFields(String formName) throws ClassNotFoundException {
...
//		return formFields;
	...
	public List<Field> getReflectionFields(String className) throws ClassNotFoundException {
		Class<?> clazz = Class.forName("com.example.generalsettings.entity." + className);
	...
	public List<Object> getGeneralSettingsListOfFieldNameValues(String fieldName, String formName) {
