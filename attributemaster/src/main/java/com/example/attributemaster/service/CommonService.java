...
public class CommonService {
	...
	public List<FormFieldResponse> getAttributeExistingFields(String formName) throws ClassNotFoundException {
...
//		return formFields;
	...
	public List<Field> getReflectionFields(String className) throws ClassNotFoundException {
		Class<?> clazz = Class.forName("com.example.plantservice.entity." + className);
	...
	public List<Object> getAttributeListOfFieldNameValues(String fieldName, String formName) {
