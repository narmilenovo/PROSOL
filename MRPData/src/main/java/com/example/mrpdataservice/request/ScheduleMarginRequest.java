...
@AllArgsConstructor
@NoArgsConstructor
public class ScheduleMarginRequest {
    @Schema(description = "Schedule Margin Code", example = "SMC001")
    private String scheduleMarginCode;

    @Schema(description = "Schedule Margin Name")
    private String scheduleMarginName;

    @Schema(description = "Schedule Margin Status", example = "true")
