...
public class AvailCheckRequest {
    ...
    @Schema(description = "AvailCheck Code", example = "1")
    private String availCheckCode;

    @Schema(description = "AvailCheck Name", example = "AvailCheck Name")
    private String availCheckName;

    @Schema(description = "AvailCheck Status", example = "true")
