...
public class CommonService {
	...
	public List<FormFieldResponse> getGeneralServiceExistingFields(String formName) throws ClassNotFoundException {
...
//		return formFields;
	...
	public List<Field> getReflectionFields(String className) throws ClassNotFoundException {
		Class<?> clazz = Class.forName("com.example.generalservice.entity." + className);
	...
	public List<Object> getGeneralServiceListOfFieldNameValues(String fieldName, String formName) {
