...
public class ValueMasterController {
    ...
    public ResponseEntity<Object> getAllValue(@RequestParam(required = false) boolean attributeUom) {
        List<?> allValue = attributeUom ?
                valueMasterService.getAllValueAttributeUom() :
    ...
    public ResponseEntity<Object> getValueById(@PathVariable Long id, @RequestParam(required = false) boolean attributeUom) throws ResourceNotFoundException {
        Object valueById = attributeUom ?
                valueMasterService.getValueAttributeUomById(id) :
                valueMasterService.getValueById(id);
