...
public class CommonService {
	...
	public List<FormFieldResponse> getRequestItemExistingFields(String formName) throws ClassNotFoundException {
...
//		return formFields;
	...
	public List<Field> getReflectionFields(String className) throws ClassNotFoundException {
		Class<?> clazz = Class.forName("com.example.requestitemservice.entity." + className);
	...
	public List<Object> getRequestItemListOfFieldNameValues(String fieldName, String formName) {
